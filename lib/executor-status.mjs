...
export const EXECUTORS_DIR = '/mnt/c/Users/relaret/agent-foundry-global/executors';
...
export function getExecutorEffectiveProfile(executorType, { model = null, effort = null, role = null } = {}) {
  ...
  if (type === 'codex') {
    ...
    const cfgPath = '/mnt/c/Users/relaret/.codex/config.toml';
  ...
  if (type === 'claude') {
    ...
    const cfgPath = '/home/relaret/.claude/settings.json';
    if (existsSync(cfgPath)) {
      try {
  ...
  if (type === 'cline') {
    ...
    const cfgPath = '/home/relaret/.cline/data/settings/providers.json';
    if (existsSync(cfgPath)) {
      try {

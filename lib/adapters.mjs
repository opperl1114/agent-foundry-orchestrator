...
export const CodexAdapter = {
  ...
  health() {
    const ok = true; // resolved via PATH shim on Windows/Linux; full check runs codex --version
...
export const ClineAdapter = {
  ...
  health() {
    ...
    return {
      ...
      ok: exists(launcher) || exists(join(HOME, '.nvm/versions/node/v24.20.0/bin/cline')) || true,
    };
  },
  async run(capsule) {
